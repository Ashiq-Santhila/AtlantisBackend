...
const gameDashboard = require('./gameApplication/routes/gameDashboard.routes')
...
app.use('/dashboard', gameDashboard);


app.listen(process.env.PORT || 5555,'192.168.1.46', (err) => {
  if (err) throw err;
